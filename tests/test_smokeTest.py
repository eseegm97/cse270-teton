...
class TestSmokeTest():
  ...
  def test_nameandLogoTest(self):
    ...
    self.driver.set_window_size(1492, 1297)
  ...
  def test_homePageTest(self):
    self.driver.get("http://localhost:5500/teton/1.6/index.html")
    self.driver.set_window_size(1648, 1077)
  ...
  def test_directoryPageTest(self):
    ...
    self.driver.set_window_size(1667, 1367)
  ...
  def test_joinPageTest(self):
    ...
    self.driver.set_window_size(1685, 1367)
    elements = self.driver.find_elements(By.NAME, "fname")
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").click()
    self.driver.find_element(By.NAME, "fname").send_keys("Hank")
    self.driver.find_element(By.NAME, "lname").click()
    self.driver.find_element(By.NAME, "lname").send_keys("H")
    self.driver.find_element(By.NAME, "lname").send_keys(Keys.DOWN)
    self.driver.find_element(By.NAME, "lname").send_keys(Keys.TAB)
    self.driver.find_element(By.NAME, "bizname").send_keys("S")
    self.driver.find_element(By.NAME, "bizname").send_keys(Keys.DOWN)
    self.driver.find_element(By.NAME, "bizname").send_keys(Keys.TAB)
    self.driver.find_element(By.NAME, "biztitle").send_keys("A")
    self.driver.find_element(By.NAME, "biztitle").send_keys(Keys.DOWN)
    self.driver.find_element(By.NAME, "biztitle").send_keys("Assistant Manager")
  ...
  def test_adminPageTest(self):
    ...
    self.driver.set_window_size(1682, 1378)
